...
/**
 * Represents a Guild-based AddOn module that can be dynamically loaded into the MCEngine.
 * <p>
 * Implement this interface to integrate guild-related features into the plugin
 * via the AddOn extension system.
 */
public interface IMCEngineGuildAddOn {
    /**
     * Called when the Guild AddOn is loaded by the engine.
     *
    ...
    /**
     * Sets a unique ID for this Guild AddOn instance.
     *
